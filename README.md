...
[![Gemma4:E2B](https://img.shields.io/badge/Gemma4:E2B-4285F4?style=for-the-badge&logo=google)](https://ai.google.dev/)
[![Nomic Embed](https://img.shields.io/badge/Nomic_Embed-FF4B4B?style=for-the-badge)](https://nomic.ai/)
[![Multi-Agent](https://img.shields.io/badge/Architecture-Multi--Agent-8A2BE2?style=for-the-badge)](#)
[![Google AI](https://img.shields.io/badge/Google_AI-4285F4?style=for-the-badge&logo=google)](https://ai.google/)
...
[![LinkedIn Demo](https://img.shields.io/badge/LinkedIn-Demo_Video-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/posts/muhammad-awais-awais-451949392_ai-multiagent-generativeai-ugcPost-7479075931219771392-fFV0/)
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/muhammad-awais)  
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/muhammad-awais-awais-451949392)

---

## 💻 Repository

[![GitHub Repository](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/muhammad-awais/multi-agent-sales-intelligence)
...
graph TD
    ...
    classDef loop fill:#ef4444,stroke:#dc2626,stroke-width:2px,color:#fff;
    classDef output fill:#f59e0b,stroke:#d97706,stroke-width:2px,color:#fff;

    User([👤 User Input]):::user --> Frontend[💻 Frontend UI]:::system
    Frontend --> Backend[⚙️ Backend API]:::system
    Backend --> Orchestrator{🎼 Orchestrator}:::system

    Orchestrator --> Scraper[🕸️ Scraper Agent]:::agent
    Scraper --> Research[🔍 Research Agent]:::agent
    Research --> BusinessAnalysis[📊 Business Analysis Agent]:::agent
    BusinessAnalysis --> SolutionMapper[🧩 Solution Mapper Agent]:::agent
    SolutionMapper --> PitchWriter[✍️ Pitch Writer Agent]:::agent
    
    PitchWriter --> Critic[⚖️ Critic Agent]:::agent
    
    Critic -->|Score < Threshold| RewriteLoop[🔄 Rewrite Loop]:::loop
    RewriteLoop --> PitchWriter
    
    Critic -->|Score >= Threshold| FinalReport([🎯 Final Report]):::output
```
